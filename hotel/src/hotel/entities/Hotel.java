...
public class Hotel {
    ...
    public long book(Room room, Guest guest,
        ...
        Long id = null;
        String s = "";
       Booking resBooking= room.book(guest, arrivalDate, stayLength, occupantNumber, creditCard);
       
       
       if (resBooking != null) {
            
            bookingsByConfirmationNumber.put(id, resBooking);
            id=resBooking.getConfirmationNumber();
